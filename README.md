...
> Built for [Agentic Commerce on Arc Hackathon](https://lablab.ai/ai-hackathons/agentic-commerce-on-arc) | Uses: Arc L1 + USDC (native gas) + Circle CCTP Bridge Kit + USYC (Hashnote Yield)
